                ...
                if (propInfo.configType == varjo_CameraPropertyConfigType_Range) {
                    ...
                    switch (propInfo.curValue.type) {
                        case varjo_CameraPropertyDataType_Int: {
                            ...
                            ImGui::SliderInt(propertyTag.c_str(), &value, static_cast<int>(propInfo.supportedValues[0].value.intValue),
                                static_cast<int>(propInfo.supportedValues[1].value.intValue));
                        ...
                        case varjo_CameraPropertyDataType_Double: {
                            float origValue = static_cast<float>(propInfo.curValue.value.doubleValue);
                            float value = origValue;

                            ImGui::SliderFloat(propertyTag.c_str(), &value, static_cast<float>(propInfo.supportedValues[0].value.doubleValue),
                                static_cast<float>(propInfo.supportedValues[1].value.doubleValue));
